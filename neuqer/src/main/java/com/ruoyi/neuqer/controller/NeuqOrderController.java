...
public class NeuqOrderController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfo<OrderDetail> list(@Validated(QueryGroup.class) SelectPageOrderBo bo, PageQuery pageQuery) {
        return iNeuqOrderService.selectPageOrderList(bo, pageQuery);
    }
