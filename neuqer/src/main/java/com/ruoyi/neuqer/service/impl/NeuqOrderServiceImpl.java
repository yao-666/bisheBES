...
import com.ruoyi.neuqer.domain.bo.SelectPageOrderBo;
...
public class NeuqOrderServiceImpl implements INeuqOrderService {
     ...
     */
    @Override
    public TableDataInfo<OrderDetail> selectPageOrderList(SelectPageOrderBo bo, PageQuery pageQuery) {
        Page<NeuqOrderVo> result = baseMapper.selectPageOrderList(pageQuery.build(), bo);
